...
```{r}
data.frame(authors = c("M Rother, J Huffman, C Guiterman, K Robertson, and N Jones"),
           year = c("In review"),
           what = c("A history of recurrent, low-severity fire without fire exclusion in southeastern pine savannas, USA"),
           journal = c("Forest Ecology and Management")
) %>% 
