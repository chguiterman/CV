...
data.frame(authors = c("C Roos, T Swetnam, T Ferguson, M Liebmann, R Loehman, J Welch, E Margolis, C Guiterman, W Hockaday, M Aiuvalasit, J Battillo, J Farella, C Kiahtipes, C Toya, P Tosa", "B Brice, CH Guiterman, C Woodhouse, C McClellan, and PR Sheppard"),
           year = c("Submitted", "In review"),
           what = c("Native American fire management at an ancient wildland-urban interface
