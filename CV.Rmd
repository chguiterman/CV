...
github: chguiterman
aboutme: |
 Forest and fire ecology | Vegetation type conversion | Forest vulnerabilities to climate change | Use-inspired research | Applications in dendrochronology
...
data.frame(authors = c("C Roos, T Swetnam, T Ferguson, M Liebmann, R Loehman, J Welch, E Margolis, C Guiterman, W Hockaday, M Aiuvalasit, J Battillo, J Farella, C Kiahtipes, C Toya, and P Tosa", "B Brice, CH Guiterman, C Woodhouse, C McClellan, and PR Sheppard"),
           year = c("Submitted", "In review"),
           title = c("Native American fire management at an ancient wildland-urban interface
in the Southwest US", "Comparing tree-ring based reconstructions of snowpack variability at different scales"),
           journal = c("Proceedings of the National Academy of Sciences", "Climate Services")
) %>% 
