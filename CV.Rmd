...
pubs <- read.csv(here("data", "publications.csv"))
```
...
```{r}
data.frame(authors = c("CH Guiterman, AM Lynch, and JN Axelson"),
           year = c("In review"),
           what = c("dfoliatR: An R package for detection and analysis of insect defoliation signals in tree rings"),
           journal = c("Dendrochronologia")
) %>% 
