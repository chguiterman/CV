...
df <- tribble(~what, ~when, ~with, ~where, ~why,
              ...
              "Author, Contributor",
              "rIMPD: Tools to search and access tree-ring fire history data on the International Multiproxy Paleofire Database", 2021, "CH Guiterman, EQ Margolis, and M Crimmins", "https://github.com/chguiterman/rIMPD", "Author, Creator",
